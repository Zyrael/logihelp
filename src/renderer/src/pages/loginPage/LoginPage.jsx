...
export function LoginPage({ login, url, updateDB }) {
  return (
    <div className='login-page'>
      <div className='db-url-container'>
        <div className='db-title'>База:</div>
        {url ? (
          url
        ) : (
      ...
      <button type='button' onClick={() => login()} disabled={!url}>
        Войти
      </button>
    </div>
  );
